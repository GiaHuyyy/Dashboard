...
export function FormActions({
  ...
  const primaryLabel = saveLabel || (isEditMode ? "Cập nhật" : "Lưu");
  const primarySaveMailLabel = saveMailLabel || (isEditMode ? "Cập nhật gửi mail" : "Lưu gửi mail");
  const primarySaveStayLabel = saveStayLabel || (isEditMode ? "Cập nhật tại trang" : "Lưu tại trang");
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
      ...
      <Button
        ...
        label="Thoát"
        onClick={() => navigate(exitPath || "/lap-trinh/danh-sach")}
        disabled={isDisabled}
        variant="danger"
      />
    </div>
