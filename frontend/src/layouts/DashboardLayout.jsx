import { Bell, ChevronLeft, Cloud, Menu, SquareArrowRightExit } from "lucide-react";
import { useDispatch, useSelector } from "react-redux";
import { NavLink, Outlet, useLocation, useNavigate } from "react-router-dom";
import { useEffect, useMemo, useState } from "react";
import { toast } from "sonner";

import { navItems, disabledNavigationMessage } from "@/config/navigation";
...
function DashboardLayout() {
  ...
  const handleDisabledClick = () => {
    toast.error(disabledNavigationMessage);
  };
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    <li key={item.path}>
                      <NavLink
                        to={itemTargetPath}
                        title={itemDisabled ? disabledNavigationMessage : undefined}
                          ...
                          {item.children.map((child) => {
                            ...
                            return (
                              <li key={child.path}>
                                <NavLink
                                  to={child.path}
                                  title={childDisabled ? disabledNavigationMessage : undefined}
